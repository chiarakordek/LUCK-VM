(() => {
  ...
  let secciones = [];
  let appConfig = { whatsapp: { numero: '5493535630595' }, catalogo: { nombre: 'Luck VM', subtitulo: '', videoUrl: 'https://www.youtube.com/embed/V8hpJz5eX38' }, costoGramo: 25, costoHora: 15, markup: 3 };
